...
function renderView(view: string): React.ReactNode {
  switch (view) {
    ...
    case 'analisis-rekap': return <AnalisisView />
    case 'pelatihan':
    case 'pelatihan-jadwal':
    case 'pelatihan-arsip': return <PelatihanView />
    case 'angkatan':
    case 'kehadiran':
    case 'pelatihan-peserta-kegiatan': return <AngkatanView />
    case 'uji-biodata':
    case 'uji-jadwal':
    case 'uji-penilaian':
    case 'uji-hasil':
    case 'uji-rekap': return <UjiKompetensiView />
    case 'uji-asesor': return <AsesorView />
    case 'peserta':
    case 'peserta-riwayat': return <PesertaView />
    case 'pendaftaran-list':
    case 'pendaftaran-dokumen': return <PendaftaranView />
    case 'monitoring-pretest':
    case 'monitoring-posttest':
    case 'monitoring-rekap': return <MonitoringView />
    case 'laporan-pelatihan':
    case 'laporan-uji':
    case 'laporan-peserta': return <LaporanView />
    case 'arsip-pelatihan':
    case 'arsip-uji':
    case 'arsip-peserta': return <ArsipView />
    case 'user-data':
    case 'user-hak-akses':
    case 'user-log': return <UserView />
    case 'backup':
    case 'backup-restore':
    case 'backup-riwayat': return <BackupView />
    case 'settings-profil':
    case 'settings-logo':
    case 'settings-login':
    case 'settings-audit': return <SettingsView />
...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-100 w-full overflow-x-hidden">
      {/* Desktop Sidebar */}
      ...
      <Sheet open={mobileSidebarOpen} onOpenChange={setMobileSidebarOpen}>
        <SheetContent side="left" className="p-0 w-72 max-w-[85vw] bg-[#0F4C81] border-r-0">
          <Sidebar userRole={user?.role || 'OPERATOR'} />
        </SheetContent>
      </Sheet>
      ...
      <div className="flex-1 flex flex-col min-w-0 w-full">
        ...
        <footer className="mt-auto bg-[#0F4C81] text-white py-3 sm:py-4 px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-center sm:text-left">
          ...
          <div className="text-blue-200 text-[11px] sm:text-xs">
