          ...
          <div className="login-bg relative z-10 overflow-hidden lg:w-[45%] flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-8 sm:px-8 sm:py-10 text-center">
              ...
              <div className="mt-3 sm:mt-4">
                ...
                <p className="font-serif-georgia text-xs sm:text-sm tracking-[0.3em] sm:tracking-[0.35em] text-[#86EFAC]/90 mt-1.5 font-semibold">Sistem Informasi Kompetensi Teknis</p>
              </div>
      ...
      <div className="relative z-10 max-w-xl w-full">
        ...
        <div className="mt-8 sm:mt-10">
          ...
          <div className="hidden lg:flex flex-wrap gap-3">
            ...
            <button
              onClick={onPrograms}
              className="flex items-center gap-3 px-10 py-3 border border-slate-300 hover:border-[#195737]/40 hover:text-[#195737] text-slate-700 font-medium text-sm rounded-xl transition-colors duration-200 cursor-pointer"
            >
...
function getContent(pageType: 'profil-bidang' | 'tentang' | 'visi-misi'): PageContent {
  if (pageType === 'profil-bidang') {
    return {
      ...
      subtitle: 'Unit pelaksana teknis di lingkungan Badan Pengembangan Sumber Daya Manusia Aceh yang mengelola pengembangan kompetensi teknis ASN.',
