      ...
      {view === 'programs' ? (
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="login-bg relative z-10 overflow-hidden lg:w-[45%] flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-5 sm:px-8 py-6 sm:py-10 text-center">
              <LogoPancaCita size={56} className="drop-shadow-2xl sm:hidden" />
              <LogoPancaCita size={100} className="drop-shadow-2xl hidden sm:block" />
              <p className="text-white/80 text-xs font-bold uppercase tracking-[0.2em] mt-2 sm:mt-3">Pemerintah Aceh</p>
              <div className="mt-3 sm:mt-5">
                <p className="text-white text-xl sm:text-3xl font-extrabold tracking-wide">SIKOMPETENSI ACEH</p>
                <p className="text-[10px] sm:text-xs tracking-[0.35em] text-[#86EFAC]/80 mt-1.5 font-medium">CORPORATE UNIVERSITY</p>
              </div>
              <div className="flex items-center justify-center mt-3 sm:mt-5 mb-3 sm:mb-5">
                <div className="h-[1px] w-6 sm:w-12 bg-gradient-to-r from-transparent to-amber-400/60" />
                <div className="h-[2px] w-12 sm:w-20 bg-gradient-to-r from-amber-500/80 via-amber-400 to-amber-500/80" />
                <div className="h-[1px] w-6 sm:w-12 bg-gradient-to-l from-transparent to-amber-400/60" />
              </div>
              <p className="text-amber-300/90 text-[10px] font-semibold uppercase tracking-[0.3em] hidden sm:block">Pemerintah Aceh</p>
              <h2 className="text-white text-sm sm:text-xl font-bold mt-3 leading-relaxed max-w-sm mx-auto">
                Membangun ASN Aceh yang profesional dan berintegritas
              </h2>
              <p className="text-white/50 text-xs mt-3 max-w-xs mx-auto leading-relaxed hidden sm:block">
      ...
      <div className="relative z-10 max-w-xl w-full">
        ...
        <div className="flex flex-wrap gap-3 mt-10">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 sm:gap-3 px-5 sm:px-10 py-3 sm:py-4 border-2 border-[#195737]/40 hover:bg-[#195737] hover:text-white hover:border-[#195737] text-[#195737] font-bold text-sm sm:text-base rounded-xl transition-all duration-200 shadow-sm hover:shadow-md"
          >
    ...
    >
      ...
      <div className="px-6 sm:px-10 pt-6 pb-4 border-b border-slate-200/60">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <button
            onClick={onLogin}
            className="flex items-center gap-2.5 px-5 sm:px-8 py-2.5 sm:py-3 bg-[#195737] hover:bg-[#0F4227] text-white text-sm font-semibold rounded-xl transition-colors duration-200"
          >
            <LogIn className="w-5 h-5" />
            Masuk Portal
          </button>
      ...
      {/* Filter tabs */}
      <div className="px-5 sm:px-10 py-3 border-b border-slate-100 overflow-x-auto">
            ...
            {filtered.map((p, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white border border-slate-200/80 rounded-xl p-4 sm:p-5 hover:border-[#195737]/20 hover:shadow-md transition-all duration-200"
                >
      ...
      {/* Footer */}
      <div className="px-5 sm:px-10 py-4 border-t border-slate-200/60">
...
function LoginRight({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, x: -20 }}
      transition={{ duration: 0.4 }}
      className="flex-1 lg:flex-1 flex items-center justify-center p-5 sm:p-10 bg-[#F5F5F7]"
    >
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-10">
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-6" noValidate>
            ...
            <div className="pt-4 pb-6">
              <button type="submit" disabled={loading} className={`w-full flex items-center justify-center gap-3 py-4 sm:py-6 text-base sm:text-xl font-bold rounded-2xl transition-all shadow-lg ${canSubmit && !loading ? 'bg-[#195737] hover:bg-[#0F4227] hover:shadow-xl hover:scale-[1.02] text-white cursor-pointer' : 'bg-slate-200 text-slate-400 cursor-not-allowed shadow-none'}`}>
                {loading ? (
